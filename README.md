...
- `figures` : Histogramme, heatmap, piechart, ...etc 
- `Data` : Donnees de challenge 
- `Rapport` : Rapport scientifique detailler
...
- évalué avec une **cross-validation**, R^2, et MAE
---
...
- Implemtation de **GridSearch**

---

## Réduction de dimension – PCA

L’**Analyse en Composantes Principales (PCA) pour les ANN** est utilisée pour :
